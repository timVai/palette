...
/**
 * Created by fanfengshi on 2018/3/5.
 */
public class ClassUtils {
     ...
     * 获取类方法上的注解
     */
    public static <A extends Annotation> A getMethodAnnotation(Class<?> clazz,Class<A> annotationClass, String methodName, Class<?>... paramType)
            throws Exception {
        try {
